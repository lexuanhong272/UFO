package com.tryon.xuanhong.tryon.object3D.models;
...
import com.tryon.xuanhong.tryon.object3D.maths.Math3DUtils;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader.FaceMaterials;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader.Faces;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader.Material;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader.Materials;
import com.tryon.xuanhong.tryon.object3D.services.WavefrontLoader.Tuple3;
...
public final class Object3DBuilder {
	...
	public static Object3DData loadFromSD(String assetDir, String assetFilename) {
		try {
			...
			data3D.setAssetsFileName(assetFilename);
			// data3D.setDrawMode(GLES20.GL_TRIANGLES);
			generateArraysSD(data3D);
	...
	public static Object3DData generateArraysSD(Object3DData obj) throws IOException {
		...
		if (materials != null) {
			materials.readMaterialsSD(obj.getCurrentDir(), obj.getAssetsDir());
			if (!faceMats.isEmpty()) {
		...
		if (materials != null && !materials.materials.isEmpty()) {
			...
			if (texture != null) {
				if (obj.getCurrentDir() != null) {
					...
					String path = Environment.getExternalStorageDirectory()+"/" + obj.getAssetsDir() + texture;
